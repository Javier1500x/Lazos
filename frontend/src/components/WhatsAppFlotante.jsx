...
export default function WhatsAppFlotante({ config }) {
      ...
      <AnimatePresence>
        {tooltip && (
          <motion.div
            ...
            className="bg-white text-gray-700 text-sm font-medium px-3 py-1.5 rounded-full shadow-md border border-green-100 whitespace-nowrap"
          >
